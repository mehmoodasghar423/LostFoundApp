...
const FoundPELocation =({ route }) => {
    ...
    const handleSelectedCity = (city) => {
        ...
        navigation.navigate('FoundPostNextEdit', { selectedCity: city,documentId });
    };
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
            ...
            <TouchableOpacity style={{ marginLeft: "5%" }} onPress={handleGoBack}>
...
export default FoundPELocation;
